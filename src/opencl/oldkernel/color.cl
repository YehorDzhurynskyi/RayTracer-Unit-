...
inline t_color	color_mult(const t_color a, const t_color b)
{
	t_color result;
...
inline t_color	color_add(const t_color a, const t_color b)
{
	t_color result;
...
inline t_color	color_scalar(const t_color color, const t_scalar factor)
{
	t_color result;
...
inline t_color	color_mix(const t_color a, const t_color b, const t_scalar factor)
{
