...
static void				render_fps(float mseconds)
{
	...
	nk_labelf_colored(g_nk_context, NK_TEXT_LEFT, nk_rgba(253, 184, 19, 255), "%4d fps",
		(int)(1000 / mseconds));
	nk_labelf_colored(g_nk_context, NK_TEXT_LEFT, nk_rgba(253, 184, 19, 255), "%.2f ms", mseconds);
