...
void					render_primitive_form(const t_shape *shape, const
t_primitive *primitive);
void					render_actual_primitive_form(const t_shape *shape,
const t_primitive *primitive);
void					render_sphere_form(const t_shape *shape,
const t_sphere *sphere);
void					render_cylinder_form(const t_shape *shape,
const t_cylinder *cylinder);
void					render_cone_form(const t_shape *shape,
const t_cone *cone);
void					render_quadric_form(const t_shape *shape,
const t_quadric_surface *quadric_surface);
...
void					render_limitations(const t_shape *shape,
const t_primitive *primitive);
void					render_lightsource_form(
const t_lightsource *lightsource);
void					render_pointlightsource_form(
const t_lightsource *lightsource,
const t_pointlightsource *pointlightsrc);
void					render_dirlightsource_form(
const t_lightsource *lightsource,
const t_dirlightsource *dirlightsrc);
void					render_spotlightsource_form(
const t_lightsource *lightsource,
