...
static cl_image_format	texture_array_image_format(void)
{
...
static cl_image_desc	texture_array_image_desc(int width, int height, int arr_size)
{
	cl_image_desc	desc;
...
{
	return (create_image(texture_array_image_format(), texture_array_image_desc(1, 1, 1), (unsigned int[]){0x0}));
}
