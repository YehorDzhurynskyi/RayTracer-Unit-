...
t_primitive	deserialize_primitive(const t_cson *cson)
{
	...
	primitive.position = deserialize_vec3_required(cson_valueof(cson, CSON_POSITION_KEY), FALSE);
	primitive.orientation = deserialize_orientation_optional(cson, (t_vec3d){0.0, 0.0, 0.0});
