...
t_err_code	validate_color_optional(const t_cson *cson, const char *key,
const char *default_value_str);

t_err_code	validate_bool_required(const t_cson *cson, const char *key);
t_err_code	validate_bool_optional(const t_cson *cson, const char *key,
const char *default_value_str);

t_err_code	validate_real_required(const t_cson *cson, const char *key);
t_err_code	validate_real_optional(const t_cson *cson, const char *key,
const char *default_value_str);
t_err_code	validate_real_required_ranged(const t_cson *cson, const char *key,
const double range[2]);
t_err_code	validate_real_optional_ranged(const t_cson *cson, const char *key,
const double range[2], const char *default_value_str);
...
t_err_code	validate_string_optional(const t_cson *cson, const char *key,
const char *default_value_str);

t_err_code	validate_vec3_required(const t_cson *cson, const char *key,
t_bool normalize);
...
t_err_code	validate_orientation_optional(const t_cson *cson, const char *key,
const char *default_angles_str);

t_err_code	validation_failed(const t_cson *cson, t_err_code err_code,
const char *message);
t_err_code	validation_failed_parent(const t_cson *cson, const char *key,
t_err_code err_code, const char *message);
t_err_code	validation_set_optional(const t_cson *cson, const char *key,
const char *default_value_str);
