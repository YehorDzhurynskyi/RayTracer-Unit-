...
static t_limitation_type	recognize_limitation_type(const char *type, t_err_code *err)
{
	...
	*err = RT_NO_REQUIRED_VALUE_ERROR;
	log_error("The limitation type is missing or can not be recognized", *err);
	return (0);
}
